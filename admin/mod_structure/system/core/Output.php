...
class CI_Output {
	...
	function _write_cache($output)
	{
		...
		$cache_path = ($path == '') ? constant($xCICurrentExtension.'APPPATH').'cache/' : $path;
	...
	{
		global $xCICurrentExtension;
		$cache_path = ($CFG->item('cache_path') == '') ? constant($xCICurrentExtension.'APPPATH').'cache/' : $CFG->item('cache_path');
