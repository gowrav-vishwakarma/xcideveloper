...
class XAVOC_Loader extends CI_Loader {
        ...
        function  __construct() {
            ...
            $this->_ci_library_paths = array(JPATH_SITE."/administrator/components/{with_component}/",JPATH_SITE."/system/", constant($xCICurrentExtension.'APPPATH')."/", BASEPATH);
            $this->_ci_helper_paths = array(JPATH_SITE."/administrator/components/{with_component}/",JPATH_SITE."/system/", constant($xCICurrentExtension.'APPPATH')."/", BASEPATH);
            $this->_ci_model_paths = array(JPATH_SITE."/administrator/components/{with_component}/",JPATH_SITE."/system/", constant($xCICurrentExtension.'APPPATH')."/");
        }
	// --------------------------------------------------------------------
