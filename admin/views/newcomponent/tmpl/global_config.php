...
<table width="100%" border="0" cellpadding="3" class="adminlist">
    <tr>
        ...
        <td><input name="includeCISystem" type="checkbox" id="includeCISystem" value="1" checked="checked" /></td>
    </tr>
    <tr class="row0">
        <td><b>Config table</b></td>
        <td><div align="left"><input type="text" name="configtable" id="configtable" size="35"/></div></td>
    </tr>
</table>
