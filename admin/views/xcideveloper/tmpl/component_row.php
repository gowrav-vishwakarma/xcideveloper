...
?><tr class="row<?php echo $i % 2 ?>">
  ...
  <td width="15"><?php echo JHTML::_('link',"index.php?option=com_xcideveloper&task=component.manage&xprjid=$row->id","Manage");?></td>
  <td width="15"><?php echo JHTML::_('link',"index.php?option=com_$row->component","Test") ; ?></td>
