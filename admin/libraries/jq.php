...
class JQ {
    ...
    function __construct() {
        ...
        $this->_js += array('js/jquery-1.4.2.js', 'js/jqnoconflict.js', 'js/ui/jquery-ui-1.8.12.custom.min.js', 'js/shortkeys.js', 'js/jquery.tooltip.js', 'js/jquery.datepick.js', 'js/formvalidator/jquery.ufvalidator.js');
...
//                " type='text/javascript'></script>\n";
            ...
            foreach ($this->_css as $s) {
                $document->addStyleSheet("${admin}components/".JRequest::getVar('option')."/libraries/jq/$s");
