...
class CI_Loader {
	...
	function __construct()
	{
		...
		$this->_ci_view_path = constant($xCICurrentExtension.'APPPATH').'views/';
		$this->_ci_ob_level  = ob_get_level();
		$this->_ci_library_paths = array(constant($xCICurrentExtension.'APPPATH'), BASEPATH);
		$this->_ci_helper_paths = array(constant($xCICurrentExtension.'APPPATH'), BASEPATH);
		$this->_ci_model_paths = array(constant($xCICurrentExtension.'APPPATH'));
...
//			return;
	...
	function helper($helpers = array())
	{
		...
		foreach ($this->_ci_prep_filename($helpers, '_helper') as $helper)
		{
			...
			$ext_helper = constant($xCICurrentExtension.'APPPATH').'helpers/'.config_item('subclass_prefix').$helper.EXT;
	...
	function remove_package_path($path = '', $remove_config_path = TRUE)
	{
		...
		$this->_ci_library_paths = array_unique(array_merge($this->_ci_library_paths, array(constant($xCICurrentExtension.'APPPATH'), BASEPATH)));
		$this->_ci_helper_paths = array_unique(array_merge($this->_ci_helper_paths, array(constant($xCICurrentExtension.'APPPATH'), BASEPATH)));
		$this->_ci_model_paths = array_unique(array_merge($this->_ci_model_paths, array(constant($xCICurrentExtension.'APPPATH'))));
		$config->_config_paths = array_unique(array_merge($config->_config_paths, array(constant($xCICurrentExtension.'APPPATH'))));
	}
	...
	function _ci_load_class($class, $params = NULL, $object_name = NULL)
	{
		...
		{
			$subclass = constant($xCICurrentExtension.'APPPATH').'libraries/'.$subdir.config_item('subclass_prefix').$class.EXT;
	...
	{
		global $xCICurrentExtension;
		include_once(constant($xCICurrentExtension.'APPPATH').'config/autoload'.EXT);
