 ...
 */
        ...
        $GLOBALS['xCICurrentExtension']="com_{component}";
        global $xCICurrentExtension;
	$application_folder = dirname(__FILE__);
        $GLOBALS['APPPATH']=$application_folder."/";
        JPluginHelper::importPlugin('{component}');
        
        $component = JFactory::getApplication('site');
        $GLOBALS['com_params'] = JComponentHelper::getParams(trim(JRequest::getVar('option')));
        $menuitemid = JRequest::getInt( 'Itemid' );
          if ($menuitemid)
          {
            $menu = JSite::getMenu();
            $GLOBALS['menu_params'] = $menu->getParams( $menuitemid );
          }
/*
 *---------------------------------------------------------------
 * SYSTEM FOLDER NAME
...
elseif (is_dir(JPATH_COMPONENT_ADMINISTRATOR . DS . "system"))
    $system_path = JPATH_COMPONENT_ADMINISTRATOR . DS . "system";
elseif (is_dir(JPATH_ROOT.DS."components".DS.JRequest::getCmd('option'). DS . "system"))
    $system_path = JPATH_ROOT.DS."components".DS.JRequest::getCmd('option'). DS . "system";
