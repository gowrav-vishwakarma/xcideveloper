...
class mod_creator extends CI_Model {
    ...
    function createNewModule($safefoldername, $prjDetails, $prjConfig) {
        ...
        if (is_dir(JPATH_SITE . DS."modules".DS."mod_" . $safefoldername)) {
            return false;
        }
//        JFolder::copy(JPATH_ADMINISTRATOR. "\\components\\com_xcideveloper\\com_structure\\admin", JPATH_ADMINISTRATOR ."\\components\\com_".$safefoldername);
        JFolder::copy(JPATH_ADMINISTRATOR . DS."components".DS."com_xcideveloper".DS."mod_structure", JPATH_SITE . DS."modules".DS."mod_" . $safefoldername);
...
//        JFile::copy(JPATH_SITE. "\\modules\\mod_$comp\\xmodule.php", JPATH_SITE ."\\modules\\mod_".$comp."\\mod_$comp.php");
        ...
        JFile::write(JPATH_SITE . DS."modules".DS."mod_" . $comp . DS."mod_$comp.php", $entryFile);

//        JFile::delete(JPATH_ADMINISTRATOR. "\\components\\com_$comp\\xcideveloper.php");
        JFile::delete(JPATH_SITE . DS."modules".DS."mod_$comp".DS."xmodule.php");
        JFile::delete(JPATH_SITE . DS."modules".DS."mod_$comp".DS."xmodule.base");
        ...
        $this->replace_component(JPATH_SITE. DS."modules".DS."mod_$comp".DS."config".DS."routes.php","{component}","mod_".$comp);
        if($prjDetails['atchwith'])
            $this->replace_component(JPATH_SITE. DS."modules".DS."mod_$comp".DS."core".DS."XAVOC_Loader.php","{with_component}","com_".$prjDetails['atchwith'], JPATH_SITE. DS."modules".DS."mod_$comp".DS."core".DS."XAVOC_Loader.php");
        else
            $this->replace_component(JPATH_SITE. DS."modules".DS."mod_$comp".DS."core".DS."XAVOC_Loader.php",'JPATH_SITE."/administrator/components/{with_component}/",','', JPATH_SITE. DS."modules".DS."mod_$comp".DS."core".DS."XAVOC_Loader.php");
        $this->replace_component(JPATH_SITE. DS."modules".DS."mod_$comp".DS."controllers".DS."welcome.php","{component}","mod_".$comp, JPATH_SITE. DS."modules".DS."mod_$comp".DS."controllers".DS."mod_$comp.php");
        JFile::delete(JPATH_SITE. DS."modules".DS."mod_$comp".DS."controllers".DS."welcome.php");
...
//        }
        ...
        JFile::write(JPATH_SITE . DS."modules".DS."mod_$comp".DS."mod_$comp.xml", $xml);
//        $atch_component=JFile::read(JPATH_COMPONENT_ADMINISTRATOR . DS . "mod_structure".DS."core".DS."XAVOC_Loader.php");
//        $atch_component = str_replace("{with_component}", $prjDetails['atchwith'], $atch_component);
//        JFile::write(JPATH_SITE . DS."modules".DS."mod_$comp".DS."XAVOC_Loader.php", $atch_component);
        return true;
    }
